                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('register.perform') }}">
                                ...
                                <div class="mb-3">
                                    <input type="password" name="password" class="form-control" placeholder="Password (min. 8 karakter)" aria-label="Password">
                                ...
                                <div class="alert alert-info text-sm mb-3" role="alert">
                                    ...
                                    <strong>Informasi:</strong> Setelah registrasi, akun Anda perlu disetujui oleh Super Admin sebelum dapat login.
                                </div>
