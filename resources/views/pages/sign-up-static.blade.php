...
<nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3 navbar-transparent mt-4">
    <div class="container">
        <a class="navbar-brand font-weight-bolder ms-lg-0 ms-3 text-white" href="{{ route('dashboard') }}">
            <img src="/img/yourstudio.png" class="navbar-brand-img h-100 me-2" alt="YourStudio Logo" style="height: 30px;">
            YourStudio
        </a>
        ...
        <div class="collapse navbar-collapse" id="navigation">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link me-2 active" aria-current="page" href="{{ route('sign-up-static') }}">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5 text-center mx-auto">
                    <h1 class="text-white mb-2 mt-5">Welcome to YourStudio!</h1>
                    <p class="text-lead text-white">Join our creative community and start managing your studio inventory with ease.</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card z-index-0">
                    ...
                    <div class="card-body">
                        <form role="form">
                            ...
                            <p class="text-sm mt-3 mb-0">Already have an account? <a href="{{ route('sign-in-static') }}"
        ...
        <div class="row">
            <div class="col-8 mx-auto text-center mt-1">
                <p class="mb-0 text-secondary">
                    ...
                    </script> YourStudio. All rights reserved.
                </p>
            </div>
        </div>
    </div>
