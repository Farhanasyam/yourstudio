...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Create Stock Adjustment'])
    <div id="alert">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        @enderror
                                        <small class="form-text text-muted">
                                            Stock After Adjustment: <span id="stock-after">-</span>
                                        </small>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('notes') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Optional additional notes about this adjustment">{{ old('notes') }}</textarea>
                                        @error('notes')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <button type="submit" class="btn btn-primary">Create Stock Adjustment</button>
                                    </div>
                                </div>
                        </div>
                        </form>
