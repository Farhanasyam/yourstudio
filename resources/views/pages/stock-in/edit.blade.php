...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Edit Stock In'])
    <div id="alert">
                ...
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between align-items-center">
                            <h6>Edit Stock In - {{ $stockIn->transaction_code }}</h6>
                    ...
                    <div class="card-body">
                        <form action="{{ route('stock-in.update', $stockIn) }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control @error('transaction_date') is-invalid @enderror" 
                                               ...
                                               value="{{ old('transaction_date', $stockIn->transaction_date->format('Y-m-d')) }}" required>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('notes') is-invalid @enderror" 
                                                  ...
                                                  placeholder="Optional notes about this transaction">{{ old('notes', $stockIn->notes) }}</textarea>
                                        @error('notes')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <input type="number" class="form-control price-input" 
                                                               name="items[{{ $index }}][purchase_price]" step="0.01" min="0" 
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h5>Total Amount: <span id="total-amount">Rp {{ number_format($stockIn->total_amount, 0, ',', '.') }}</span></h5>
                                        <div>
    ...
    <script>
        let itemIndex = {{ count($stockIn->details) }};
