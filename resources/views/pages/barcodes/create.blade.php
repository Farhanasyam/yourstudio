...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Create Barcode'])
    <div id="alert">
            ...
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form role="form" method="POST" action="{{ route('barcodes.store') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small id="barcodeHelp" class="form-text text-muted">
                                            Select barcode type first, then generate or enter manually
                                        </small>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control @error('barcode_type') is-invalid @enderror" 
                                            ...
                                            <option value="CODE128" {{ old('barcode_type', 'CODE128') == 'CODE128' ? 'selected' : '' }}>CODE128 (Alphanumeric)</option>
                                            <option value="CODE39" {{ old('barcode_type') == 'CODE39' ? 'selected' : '' }}>CODE39 (Alphanumeric)</option>
                                            <option value="EAN13" {{ old('barcode_type') == 'EAN13' ? 'selected' : '' }}>EAN13 (13 digits only)</option>
                                            <option value="QR" {{ old('barcode_type') == 'QR' ? 'selected' : '' }}>QR Code</option>
                                        </select>
                                        @error('barcode_type')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted">Set as active barcode for this item (only one can be active per item)</small>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <div id="barcodePreview" class="border p-3 text-center bg-light" style="min-height: 120px;">
                                            <small class="text-muted">Enter barcode number and select type to see preview</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save"></i> Create Barcode
                                </button>
